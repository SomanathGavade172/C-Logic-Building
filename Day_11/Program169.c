...
//  Description      : This function accepts a character pointer and counts the number of vowels (a, e, i, o, u) present in the given string.
...
//  Description      : This application accepts a string from the user and counts the number of vowels present in it using a user-defined function 
